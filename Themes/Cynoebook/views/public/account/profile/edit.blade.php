            ...
            <div class="container">
                <div class="register-wrapper rlp-wrapper">
                    <div class="register-table rlp-table">
                        <div class="register-title rlp-title">{{ clean(trans('cynoebook::account.profile.edit_profile')) }}</div>
                        <form method="POST" action="{{ route('account.profile.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('first_name') ? 'has-error': '' }}">
                                                <label for="first-name" class="control-label form-label">
                                                    {{ clean(trans('cynoebook::account.profile.first_name')) }}<span>*</span>
                                                </label>

                                                <input type="text" name="first_name" id="first-name" class="form-control form-input" value="{{ old('first_name', $my->first_name) }}">
                            ...
                            <button type="submit" class="btn btn-green" data-loading>
                               <span> {{ clean(trans('cynoebook::account.profile.save_changes')) }}</span>
                            </button>
                        </form>
                    </div>
                </div>
