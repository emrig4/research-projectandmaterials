...
class WPDM_Button_Templates {
    ...
    function template($params){
        ...
        $link_label = __( "Download", "download-manager" ); //$package['link_label'];
        $file_size = get_post_meta($id, '__wpdm_package_size', true);
        $icon = \WPDM\Package::icon($id);
        $html = <<<HTML
        <div class="w3eden">
<div class="w3eden-link-btn w3eden-{$style}  p{$align}">
    <div class="media">
        <div class="pull-left wbt-left mr-3"><div class="wbt-icon"><img src="{$icon}" class="wpdm_icon-bt"></div></div>
...
<script>
jQuery(function(){
jQuery('.w3eden-link-btn a.wpdm-download-link img').after('{$link_label}');
jQuery('.w3eden-link-btn a.wpdm-download-link img').remove();
});
</script>
HTML;
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <select id="btpls_style">
                    <option value="bs btn btn-default">Bootstrap Default</option>
                    <option value="bs btn btn-primary">Bootstrap Primary</option>
                    <option value="bs btn btn-secondary">Bootstrap Secondary</option>
                    <option value="bs btn btn-info">Bootstrap Info</option>
                    <option value="bs btn btn-success">Bootstrap Success</option>
                    <option value="bs btn btn-danger">Bootstrap Danger</option>
                    <option value="bs btn btn-warning">Bootstrap Warning</option>
