                    ...
                    <div class="form-inner clearfix"> 
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        ...
                                        <div class="link-field upload-field {{ old('file_type',$ebook->file_type) !== 'upload' ? 'hide' :'' }}">    
                                            ...
                                            <div class="image-placeholder">
                                                <a type="button" class="btn btn-green btn-sm" href="{{ route('ebooks.download',[$ebook->slug,id_encode($ebook->book_file->id)])}}" data-toggle="tooltip" data-placement="top" title="{{ clean(trans('cynoebook::ebook.download')) }}"><i class="fa fa-download" aria-hidden="true" ></i> <span>{{$ebook->book_file->filename}}</span></a>
                                            </div>
                                            </div>
                                        @endif
                        ...
                        <div class="col-md-12">
                            <div class="form-group pull-right">
                                <button type="submit" class="btn btn-green btn-primary" data-loading>
                                    <span>{{ clean(trans('cynoebook::ebook.upload_Ebook')) }}</span>
                                </button>
                            </div>
                        </div>
