...
use ArtisansWeb\Optimizer as Opt;
use ArtisansWeb\Exception\CurlException;


class Optimizer extends Opt
{
    ...
    // changed to the api endpoint in order to trigger php inbuilt method, which happens to compress jpeg better and faster
    public $api_endpoint = 'http://api.resmush.it';
    ...
    public function optimize($source = '', $destination = '')
    {
        ...
        try {
            ...
            // if jpeg use native compression
            // if($this->mime === "image/jpeg" || $this->ext === 'jpeg'){
            //     return $this->compressImage();
            // }
            // // if jpeg use native compression
            // if($this->mime === "image/jpg" || $this->ext === 'jpg'){
            //     return $this->compressImage();
            // }
