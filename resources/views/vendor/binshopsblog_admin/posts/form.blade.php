...
<!-- airon here added featured to payload -->
<div class='row'>
    ...
    <div class='col-sm-12 col-md-4'>
        ...
        <div class="form-group">
            <label for="blog_subtitle">Featured</label>
            <select name='is_featured' class='form-control' id='blog_is_published'
                    aria-describedby='blog_is_published_help'>

                <option @if(old("is_featured",$post->is_featured) == '1') selected='selected' @endif value='1'>
                    Featured
                </option>
                <option @if(old("is_featured",$post->is_featured) == '0') selected='selected' @endif value='0'>Not
                    Featured
                </option>

            </select>
            <small id="blog_subtitle_help" class="form-text text-muted">Display on homepage</small>
        </div>
    </div>
</div>
...
<div class="form-group">
    <label for="blog_meta_desc">Meta Keywords (optional)</label>
    <textarea class="form-control" id="blog_meta_keywords" aria-describedby="blog_meta_keywords_help"
              name='meta_keywords'>{{old("meta_keywords",$post->meta_keywords)}}</textarea>
    <small id="blog_meta_keywords_help" class="form-text text-muted">Meta Keywords (optional)</small>
</div>
