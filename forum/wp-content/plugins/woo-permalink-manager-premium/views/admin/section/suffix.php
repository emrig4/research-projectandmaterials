    ...
    <tr>
        <th>
            ...
            <p class="description">
				...
				<?php _e( 'Specify suffix for your urls. For example ', 'premmerce-url-manager' ) ?> <b>.html</b>
            </p>
        </th>
    </tr>
    ...
    <tr>
        <th>
            <label class="premium-only-label">
				...
				<?php _e( 'Enable for products', 'premmerce-url-manager' ) ?>
            </label>
            <p class="description">
                <span class="premium-only-feature"><?php _e( 'Available only in premium version', 'premmerce-url-manager' ) ?></span>
                <br>
    ...
    <tr>
        <th>
            <label class="premium-only-label">
				...
				<?php _e( 'Enable for categories', 'premmerce-url-manager' ) ?>
            </label>
            <p class="description">
                <span class="premium-only-feature"><?php _e( 'Available only in premium version', 'premmerce-url-manager' ) ?></span>
                <br>
