...
{{ Form::text('page_counts', 'Number of Pages', $errors, $ebook, []) }}
{{ Form::text('price', clean(trans('ebook::attributes.price')), $errors, $ebook, []) }}

<!-- airon add currency -->
{{ Form::select('currency_id', 'Currency', $errors, $currencies, $ebook, ['class' => 'select2']) }}
...
<!-- only admin and publisher can enable a book  -->
@if ( Sentinel::getUser()->inRole('admin', 'publisher') )
...
{{ Form::checkbox('is_featured', clean(trans('ebook::attributes.is_featured')), clean(trans('ebook::ebooks.form.feature_the_ebook')), $errors, $ebook, ['required' => false, 'disabled' => 'disabled']) }}

{{ Form::checkbox('is_active', clean(trans('ebook::attributes.is_active')), clean(trans('ebook::ebooks.form.enable_the_ebook')), $errors, $ebook, ['required' => false, 'disabled' => 'disabled'] ) }}
