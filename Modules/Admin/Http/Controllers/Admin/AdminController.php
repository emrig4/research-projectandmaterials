...
class AdminController extends Controller
{
    ...
    public function index()
    {
        return view('admin::dashboard.index', [
            ...
            'thisMonthPurchases' => $this->getThisMonthPurchases(),
            'todayPurchases' => $this->getTodayPurchases(),
    ...
    {
       return PurchasedEbook::all()->count();
    }

    private function getThisMonthPurchases()
    {
        return PurchasedEbook::all()->where(
            'created_at', '>=', Carbon::now()->startOfMonth()->toDateString()
        )->count();
    }


    private function getTodayPurchases()
    {
