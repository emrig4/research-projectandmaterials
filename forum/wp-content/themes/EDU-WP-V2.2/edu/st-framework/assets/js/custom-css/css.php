...
function st_css_display(){
    ...
    ?>
     <link rel="stylesheet" href="<?php echo ST_ADMIN_URL; ?>custom-css/codemirror.css">
    <script src="<?php echo ST_ADMIN_URL; ?>custom-css/codemirror.js"></script>
    <script src="<?php echo ST_ADMIN_URL; ?>custom-css/css.js"></script>
    <style type="text/css">
        .CodeMirror {
