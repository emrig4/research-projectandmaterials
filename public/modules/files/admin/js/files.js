!(function (e) {
    ...
    26: function (e, t, n) {
        ...
        function p(e, t) {
            for (var n = 0; n < e.length; n++) {
                ...
                if (o) {
                    ...
                    var r = [];
                    for (a = 0; a < i.parts.length; a++) r.push(y(i.parts[a], t));
                    s[i.id] = {
                        id: i.id,
                        refs: 1,
                        parts: r,
        ...
        function y(e, t) {
            ...
            if (t.singleton) {
                var a = u++;
                (n = c || (c = v(t))), (i = k.bind(null, n, a, !1)), (o = k.bind(null, n, a, !0));
            } else
        ...
        function S(e, t, n) {
            ...
            (t.convertToAbsoluteUrls || s) && (i = h(i)), o && (i += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
            var a = new Blob([i], {
                    type: "text/css",
                }),
                r = e.href;
    ...
    27: function (e, t) {
        e.exports = function (e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
                ...
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(s) ? e : ((o = 0 === s.indexOf("//") ? s : 0 === s.indexOf("/") ? n + s : i + s.replace(/^\.\//, "")), "url(" + JSON.stringify(o) + ")");
            });
        };
    },
    29: function (e, t, n) {
                    ...
                    n.extend(m.prototype, {
                        init: function () {
                            ...
                            a.closeExisting && n.fancybox.close(!0),
                                ...
                                !n.fancybox.getInstance() &&
                                    ...
                                    (n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar{margin-right:' + (e.innerWidth - t.documentElement.clientWidth) + "px;}</style>"), n("body").addClass("compensate-for-scrollbar")),
                                (o = ""),
                                n.each(a.buttons, function (e, t) {
                                    o += a.btnTpl[t] || "";
                                }),
                                (i = n(s.translate(s, a.baseTpl.replace("{{buttons}}", o).replace("{{arrows}}", a.btnTpl.arrowLeft + a.btnTpl.arrowRight)))
                        ...
                        addContent: function (e) {
                            ...
                            n.each(o, function (e, t) {
                                ...
                                n.isPlainObject(t)
                                    ...
                                    ? ((u = (o = n(t)).data() || {}), ((u = n.extend(!0, {}, u, u.options)).$orig = o), (c.src = i.opts.src || u.src || o.attr("href")), c.type || c.src || ((c.type = "inline"), (c.src = t)))
                                    : (c = {
                                          type: "html",
                                          src: t + "",
                                      }),
                                    ...
                                    !s &&
                                        ...
                                        ((a = r.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                                            ? ((s = "video"), c.opts.video.format || (c.opts.video.format = "video/" + ("ogv" === a[1] ? "ogg" : a[1])))
                        ...
                        jumpTo: function (e, t) {
                            ...
                            if (!(h.isDragging || h.isClosing || (h.isAnimating && h.firstRun))) {
                                ...
                                if (
                                    ((i = h.firstRun = !Object.keys(h.slides).length),
                                    (r = h.current),
                                    ...
                                    return a.opts.animationEffect && t && h.$refs.container.css("transition-duration", t + "ms"), h.$refs.container.addClass("fancybox-is-open").trigger("focus"), h.loadSlide(a), void h.preload("image");
                                (l = n.fancybox.getTranslate(r.$slide)),
                                    ...
                                    o
                                        ? ((d = l.left - (r.pos * l.width + r.pos * r.opts.gutter)),
                        ...
                        createSlide: function (e) {
                            ...
                            return (
                                ...
                                !this.slides[e] &&
                                    this.group[i] &&
                                    ((t = n('<div class="fancybox-slide"></div>').appendTo(this.$refs.stage)),
                        ...
                        scaleToActual: function (e, t, i) {
                            ...
                            c.isAnimating ||
                                ...
                                (s = 0.5 * h - 0.5 * f),
                                (a = 0.5 * p - 0.5 * m),
                                f > h && ((s = o.left * r - (e * r - e)) > 0 && (s = 0), s < h - f && (s = h - f)),
                                m > p && ((a = o.top * l - (t * l - t)) > 0 && (a = 0), a < p - m && (a = p - m)),
                                c.updateCursor(f, m),
                                n.fancybox.animate(
                                    d,
                                    {
                        ...
                        getFitPos: function (e) {
                            ...
                            return (
                                ...
                                (t -= parseFloat(r.css("paddingLeft")) + parseFloat(r.css("paddingRight")) + parseFloat(a.css("marginLeft")) + parseFloat(a.css("marginRight"))),
                                (i -= parseFloat(r.css("paddingTop")) + parseFloat(r.css("paddingBottom")) + parseFloat(a.css("marginTop")) + parseFloat(a.css("marginBottom"))),
                                (l && c) || ((l = t), (c = i)),
                                (l *= o = Math.min(1, t / l, i / c)) > t - 0.5 && (l = t),
                                (c *= o) > i - 0.5 && (c = i),
                                "image" === e.type
                                    ? ((u.top = Math.floor(0.5 * (i - c)) + parseFloat(r.css("paddingTop"))), (u.left = Math.floor(0.5 * (t - l)) + parseFloat(r.css("paddingLeft"))))
                        ...
                        updateSlide: function (e, t) {
                            ...
                            this.adjustCaption(e),
                                i && (o || s || "video" === e.contentType) && !e.hasError && (n.fancybox.stop(i), n.fancybox.setTranslate(i, this.getFitPos(e)), e.pos === this.currPos && ((this.isAnimating = !1), this.updateCursor())),
                                this.adjustLayout(e),
                                a.length && (a.trigger("refresh"), e.pos === this.currPos && this.$refs.toolbar.add(this.$refs.navigation.find(".fancybox-button--arrow_right")).toggleClass("compensate-for-scrollbar", a.get(0).scrollHeight > a.get(0).clientHeight)),
                        ...
                        updateCursor: function (e, t) {
                            ...
                            s &&
                                ...
                                i
                                    ...
                                    : s.opts.touch && (s.opts.touch.vertical || this.group.length > 1) && "video" !== s.contentType && a.addClass("fancybox-can-swipe"));
                        },
                        isZoomable: function () {
                            var e,
                                t = this.current;
                            ...
                            (e.$image = s
                                ...
                                .one("load", function () {
                                    ...
                                    e.$ghost || (i.resolveImageSlideSize(e, this.naturalWidth, this.naturalHeight), i.afterLoad(e)),
                                        i.isClosing ||
                                            (e.opts.srcset && (((t = e.opts.sizes) && "auto" !== t) || (t = (e.width / e.height > 1 && r.width() / r.height() > 1 ? "100" : Math.round((e.width / e.height) * 100)) + "vw"), s.attr("sizes", t).attr("srcset", e.opts.srcset)),
                                            e.$ghost &&
                                                setTimeout(function () {
                        ...
                        setContent: function (e, t) {
                            ...
                            this.isClosing ||
                                ...
                                (i = t) && i.hasOwnProperty && i instanceof n && t.parent().length
                                    ? ((t.hasClass("fancybox-content") || t.parent().hasClass("fancybox-content")) && t.parents(".fancybox-slide").trigger("onReset"), (e.$placeholder = n("<div>").hide().insertAfter(t)), t.css("display", "inline-block"))
                                ...
                                n(t).is("video,audio") && (n(t).addClass("fancybox-video"), n(t).wrap("<div></div>"), (e.contentType = "video"), (e.opts.width = e.opts.width || n(t).attr("width")), (e.opts.height = e.opts.height || n(t).attr("height"))),
                        ...
                        adjustCaption: function (e) {
                            ...
                            s.toggleClass("fancybox-caption--separate", o),
                                o &&
                                    i &&
                                    i.length &&
                                    (n.pos !== this.currPos ? ((t = s.clone().appendTo(s.parent())).children().eq(0).empty().html(i), (a = t.outerHeight(!0)), t.empty().remove()) : this.$caption && (a = this.$caption.outerHeight(!0)), n.$slide.css("padding-bottom", a || ""));
                        },
                        ...
                        revealContent: function (e) {
                            ...
                            return (
                                ...
                                (!u && e.pos === a.currPos && o) || (t = !1),
                                "zoom" === t && (e.pos === a.currPos && o && "image" === e.type && !e.hasError && (c = a.getThumbPos(e)) ? (l = a.getFitPos(e)) : (t = "fade")),
                                "zoom" === t
                                    ? ((a.isAnimating = !0),
                                    ...
                                    : (a.updateSlide(e),
                                      t
                                          ...
                                          : (e.$content.removeClass("fancybox-is-hidden"), d || !u || "image" !== e.type || e.hasError || e.$content.hide().fadeIn("fast"), void (e.pos === a.currPos && a.complete())))
                            );
                        },
                        ...
                        focus: function (e, i) {
                            ...
                            this.isClosing ||
                                ((o = (o = !e && this.current && this.current.isComplete ? this.current.$slide.find("*:visible" + (i ? ":not(.fancybox-close-small)" : "")) : this.$refs.container.find("*:visible")).filter(a).filter(function () {
                                    return "hidden" !== n(this).css("visibility") && !n(this).hasClass("disabled");
                                })).length
                                    ? ((s = o.index(t.activeElement)), e && e.shiftKey ? (s < 0 || 0 == s) && (e.preventDefault(), o.eq(o.length - 1).trigger("focus")) : (s < 0 || s == o.length - 1) && (e && e.preventDefault(), o.eq(0).trigger("focus")))
                            ...
                            return (
                                ...
                                !1 === d.trigger("beforeClose", e)
                                    ...
                                    : (d.removeEvents(),
                                      ...
                                      !0 !== e ? n.fancybox.stop(h.$slide) : (i = !1),
                                      ...
                                      d.hideControls(!0),
                                      d.updateCursor(),
                                      "zoom" !== i || (s && o && "image" === h.type && !d.isMoved() && !h.hasError && (c = d.getThumbPos(h))) || (i = "fade"),
                                      "zoom" === i
                                          ? (n.fancybox.stop(s),
                                            (l = {
                                            ...
                                            !0)
                                          : (i && o ? n.fancybox.animate(h.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + i, o, f) : !0 === e ? setTimeout(f, o) : f(), !0)))
                            );
                        },
                        cleanUp: function (t) {
                            var i,
                            ...
                            this.current.$slide.trigger("onReset"),
                                ...
                                this.current.opts.backFocus && ((a && a.length && a.is(":visible")) || (a = this.$trigger), a && a.length && ((o = e.scrollX), (s = e.scrollY), a.trigger("focus"), n("html, body").scrollTop(s).scrollLeft(o))),
                                (this.current = null),
                        ...
                        trigger: function (e, t) {
                            ...
                            if ((a ? o.unshift(a) : (a = s), o.unshift(s), n.isFunction(a.opts[e]) && (i = a.opts[e].apply(a, o)), !1 === i)) return i;
                        ...
                        updateControls: function () {
                            ...
                            e.$slide.trigger("refresh"),
                                a && a.length ? ((this.$caption = s), s.children().eq(0).html(a)) : (this.$caption = null),
                        ...
                        (n.fancybox = {
                            ...
                            setTranslate: function (e, t) {
                                ...
                                if (e && t)
                                    return (
                                        (void 0 === t.left && void 0 === t.top) || ((n = (void 0 === t.left ? e.position().left : t.left) + "px, " + (void 0 === t.top ? e.position().top : t.top) + "px"), (n = this.use3d ? "translate3d(" + n + ", 0px)" : "translate(" + n + ")")),
            ...
            function g(e, t) {
                ...
                (e && e.isDefaultPrevented()) ||
                    ...
                    ((s = n.fancybox.getInstance()) && s.$trigger && s.$trigger.is(i)) ||
                        ...
                        (r = n(a).index(i)) < 0 && (r = 0),
                        ((s = n.fancybox.open(a, t, r)).$trigger = i)));
            }
                    ...
                    (a = e.extend(!0, {}, t, s.opts.media)),
                        e.each(a, function (t, i) {
                            if ((l = p.match(i.matcher))) {
                                ...
                                return (
                                    (c = e.extend(!0, {}, i.params, s.opts[t], d)),
                                    (p = "function" === e.type(i.url) ? i.url.call(this, l, c, s) : n(i.url, l, c)),
                                    (r = "function" === e.type(i.thumb) ? i.thumb.call(this, l, c, s) : n(i.thumb, l)),
                                    "youtube" === t
                    ...
                    l = function (t) {
                        for (
                            ...
                            (n = t.get(0)),
                                ...
                                !(r = s || a) && (t = t.parent()).length && !t.hasClass("fancybox-stage") && !t.is("body");
                ...
                (c.prototype.destroy = function () {
                    ...
                    (c.prototype.ontouchstart = function (i) {
                        var o = n(i.target),
                            ...
                            h = u.$content,
                            p = "touchstart" == i.type;
                        if ((p && this.$container.off("mousedown.fb.touch"), (!i.originalEvent || 2 != i.originalEvent.button) && d.length && o.length && !r(o) && !r(o.parent()) && (o.is("img") || !(i.originalEvent.clientX > o[0].clientWidth + o.offset().left)))) {
                        ...
                        if (!0 !== l)
                            ...
                            if (
                                ...
                                r.group.length < 2 && a.opts.vertical
                                    ? (a.isSwiping = "y")
                                    : r.isDragging || !1 === a.opts.vertical || ("auto" === a.opts.vertical && n(e).width() > 800)
                                    ? (a.isSwiping = "x")
                            ...
                            (r.isDragging = a.isSwiping),
                                ...
                                n.each(r.slides, function (e, t) {
                                    ...
                                    n.fancybox.stop(t.$slide),
                                        ...
                                        t.pos === r.current.pos && ((a.sliderStartPos.top = i.top - o.top), (a.sliderStartPos.left = i.left - o.left)),
                                        n.fancybox.setTranslate(t.$slide, {
                                            top: i.top - o.top,
                                            left: i.left - o.left,
                                        });
                    ...
                    (c.prototype.limitMovement = function () {
                        ...
                        return (
                            ...
                            l > 0 && o > e && (o = e - 1 + Math.pow(-e + d + l, 0.8) || 0),
                            l < 0 && o < n && (o = n + 1 - Math.pow(n - d - l, 0.8) || 0),
                    ...
                    (c.prototype.limitPosition = function (e, t, n, i) {
                        var o = this.canvasWidth,
                            s = this.canvasHeight;
                        return (
                            (e = n > o ? ((e = e > 0 ? 0 : e) < o - n ? o - n : e) : Math.max(0, o / 2 - n / 2)),
                            {
                    ...
                    (c.prototype.ontouchend = function (e) {
                        ...
                        if (
                            ...
                            return this.onTap(e);
                        (this.speed = 100), (this.velocityX = (this.distanceX / this.dMs) * 0.5), (this.velocityY = (this.distanceY / this.dMs) * 0.5), a ? this.endPanning() : r ? this.endZooming() : this.endSwiping(i, l);
                    }),
                    (c.prototype.endSwiping = function (e, t) {
                        var i = !1,
                            o = this.instance.group.length,
                            s = Math.abs(this.distanceX),
                            a = "x" == e && o > 1 && ((this.dMs > 130 && s > 10) || s > 50);
                        (this.sliderLastPos = null),
                            "y" == e && !t && Math.abs(this.distanceY) > 50
                                ...
                                : a && this.distanceX < 0 && (i = this.instance.next(300)),
                    ...
                    (c.prototype.endPanning = function () {
                        var e, t, i;
                        this.contentLastPos &&
                            (!1 === this.opts.momentum || this.dMs > 350 ? ((e = this.contentLastPos.left), (t = this.contentLastPos.top)) : ((e = this.contentLastPos.left + 500 * this.velocityX), (t = this.contentLastPos.top + 500 * this.velocityY)),
                    ...
                    (c.prototype.endZooming = function () {
                        ...
                        this.contentLastPos &&
                            ...
                            a < this.canvasWidth && r < this.canvasHeight
                                ...
                                : ((i = this.limitPosition(e, t, a, r)), n.fancybox.animate(this.$content, i, 150)));
                    }),
                                ...
                                if ((n.isFunction(i) && (i = i.apply(r, [l, t])), i))
                                    switch (i) {
                                        ...
                                        case "nextOrClose":
                                            ...
                                            break;
                                        case "zoom":
                                            "image" == l.type && (l.isLoaded || l.$ghost) && (r.canPan() ? r.scaleToFit() : r.isScaledDown() ? r.scaleToActual(u, d) : r.group.length < 2 && r.close(o.startEvent));
                                    }
                            };
                                ...
                                (o.tapX = u),
                                    ...
                                    l.opts["dblclick" + i] && l.opts["dblclick" + i] !== l.opts["click" + i]
                                        ? (o.tapped = setTimeout(function () {
                                              (o.tapped = null), r.isAnimating || h("click" + i);
                                          }, 500))
                                        : h("click" + i);
                            return this;
                        }
                ...
                t.extend(i.prototype, {
                    ...
                    create: function () {
                        var e,
                            ...
                            s = [];
                        this.$grid ||
                            ((this.$grid = t('<div class="' + n + " " + n + "-" + this.opts.axis + '"></div>').appendTo(i.$refs.container.find(o).addBack().filter(o))),
                    ...
                    focus: function (e) {
                        ...
                        this.instance.current &&
                            ...
                            "y" === this.opts.axis && (n.top < 0 || n.top > i.height() - t.outerHeight())
                                ...
                                : "x" === this.opts.axis &&
                                  (n.left < o.scrollLeft() || n.left > o.scrollLeft() + (o.width() - t.outerWidth())) &&
                ...
                t.extend(!0, t.fancybox.defaults, {
                    ...
                    t(e).on("click", "[data-fancybox-share]", function () {
                        var e,
                            ...
                            a = s.current || null;
                        a &&
                            ("function" === t.type(a.opts.share.url) && (e = a.opts.share.url.apply(a, [s, a])),
                            (n = a.opts.share.tpl
                            ...
                            (n(t).on({
                                ...
                                "beforeShow.fb": function (n, i, o, a) {
                                    ...
                                    o &&
                                        !1 !== o.opts.hash &&
                                        (r = s(i)) &&
                                        ((i.currentHash = r + (i.group.length > 1 ? "-" + (o.index + 1) : "")),
                                        e.location.hash !== "#" + i.currentHash &&
                                            (a && !i.origHash && (i.origHash = e.location.hash),
                                            i.hashTimer && clearTimeout(i.hashTimer),
                                            (i.hashTimer = setTimeout(function () {
                                                "replaceState" in e.history ? (e.history[a ? "pushState" : "replaceState"]({}, t.title, e.location.pathname + e.location.search + "#" + i.currentHash), a && (i.hasCreatedHistory = !0)) : (e.location.hash = i.currentHash),
                                                    (i.hashTimer = null);
                                            }, 300))));
                                },
                    ...
                    "onInit.fb": function (e, t, i) {
                        t.$refs.stage.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function (e) {
                            ...
                            t.group.length < 2 ||
                                ...
                                (e.preventDefault(), e.stopPropagation(), i.$slide.hasClass("fancybox-animated") || ((e = e.originalEvent || e), o - n < 250 || ((n = o), t[(-e.deltaY || -e.deltaX || e.wheelDelta || -e.detail) < 0 ? "next" : "previous"]())));
                        });
                    },
                });
            })(document, jQuery);
        ...
        (function (e) {
            ...
            var o = (function () {
                ...
                s = (function (e) {
                    function s(e, t) {
                        i(this, s);
                        var o,
                            a = n(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this)),
                            r = void 0;
                        if (
                            ((a.element = e),
                            (a.version = s.version),
                            (a.defaultOptions.previewTemplate = a.defaultOptions.previewTemplate.replace(/\n*/g, "")),
                            (a.clickableElements = []),
                            (a.listeners = []),
                            (a.files = []),
                            "string" == typeof a.element && (a.element = document.querySelector(a.element)),
                            !a.element || null == a.element.nodeType)
                        )
                            throw new Error("Invalid dropzone element.");
                        if (a.element.dropzone) throw new Error("Dropzone already attached.");
                        s.instances.push(a), (a.element.dropzone = a);
                        var l,
                            c = null != (o = s.optionsForElement(a.element)) ? o : {};
                        if (((a.options = s.extend({}, a.defaultOptions, c, null != t ? t : {})), a.options.forceFallback || !s.isBrowserSupported())) return (l = a.options.fallback.call(a)), n(a, l);
                        ...
                        return (
                            a.options.acceptedMimeTypes && ((a.options.acceptedFiles = a.options.acceptedMimeTypes), delete a.options.acceptedMimeTypes),
                            ...
                            (r = a.getExistingFallback()) && r.parentNode && r.parentNode.removeChild(r),
                            !1 !== a.options.previewsContainer && (a.options.previewsContainer ? (a.previewsContainer = s.getElement(a.options.previewsContainer, "previewsContainer")) : (a.previewsContainer = a.element)),
                            a.options.clickable && (!0 === a.options.clickable ? (a.clickableElements = [a.element]) : (a.clickableElements = s.getElements(a.options.clickable, "clickable"))),
                            a.init(),
                            a
                        );
                    }
                                        ...
                                        (this.prototype.defaultOptions = {
                                            ...
                                            resize: function (e, t, n, i) {
                                                var o = {
                                                    ...
                                                    s = e.width / e.height;
                                                null == t && null == n ? ((t = o.srcWidth), (n = o.srcHeight)) : null == t ? (t = n * s) : null == n && (n = t / s);
                                                var a = (t = Math.min(t, o.srcWidth)) / (n = Math.min(n, o.srcHeight));
                                                if (o.srcWidth > t || o.srcHeight > n)
                                                    if ("crop" === i) s > a ? ((o.srcHeight = e.height), (o.srcWidth = o.srcHeight * a)) : ((o.srcWidth = e.width), (o.srcHeight = o.srcWidth / a));
                                                    else {
                                            ...
                                            addedfile: function (e) {
                                                ...
                                                if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                                    ...
                                                    for (var a = 0, r = (r = e.previewElement.querySelectorAll("[data-dz-size]")); !(a >= r.length); ) (o = r[a++]).innerHTML = this.filesize(e.size);
                                                    this.options.addRemoveLinks && ((e._removeLink = s.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>")), e.previewElement.appendChild(e._removeLink));
                                                    for (
                                                        var l = function (n) {
                                                                return (
                                                                    n.preventDefault(),
                                                            ...
                                                            c = 0,
                                                            u = (u = e.previewElement.querySelectorAll("[data-dz-remove]"));
                                                        ;
                        ...
                        t(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        if (
                                            ...
                                            this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(s.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")),
                                        ...
                                        return (
                                            ...
                                            this.clickableElements.forEach(function (t) {
                                                return e.listeners.push({
                                                    ...
                                                    events: {
                                                        click: function (n) {
                                                            return (t !== e.element || n.target === e.element || s.elementInside(n.target, e.element.querySelector(".dz-message"))) && e.hiddenFileInput.click(), !0;
                                                        },
                                                    },
                                                });
                                            }),
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            "FORM" !== this.element.tagName
                                                ? (t = s.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')).appendChild(i)
                                        ...
                                        if (e > 0) {
                                            for (var i = ["tb", "gb", "mb", "kb", "b"], o = 0; o < i.length; o++) {
                                                ...
                                                if (e >= Math.pow(this.options.filesizeBase, 4 - o) / 10) {
                                                    (t = e / Math.pow(this.options.filesizeBase, 4 - o)), (n = s);
                                                    break;
                                                }
                                            }
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        for (var t = 0, n = (n = this.files.slice()); ; ) {
                                            if (t >= n.length) break;
                                            var i = n[t++];
                                            (i.status !== s.UPLOADING || e) && this.removeFile(i);
                                        }
                                        return null;
                                    },
                                },
                                {
                                    ...
                                    value: function (e, t, n, i, o) {
                                        ...
                                        return this.createThumbnail(e, t, n, i, !0, function (t, n) {
                                            ...
                                            null == i && (i = e.type);
                                            var r = n.toDataURL(i, a.options.resizeQuality);
                                            return ("image/jpeg" !== i && "image/jpg" !== i) || (r = c.restore(e.dataURL, r)), o(s.dataURItoBlob(r));
                                        });
                                    },
                                },
                                {
                                    ...
                                    value: function (e, t, n, i, o, s) {
                                        ...
                                        return (
                                            (r.onload = function () {
                                                if (((e.dataURL = r.result), "image/svg+xml" !== e.type)) return a.createThumbnailFromUrl(e, t, n, i, o, s);
                                                null != s && s(r.result);
                                            }),
                                            r.readAsDataURL(e)
                                        );
                                            ...
                                            (c.onload = function () {
                                                ...
                                                return (
                                                    ...
                                                    a(function (o) {
                                                        ...
                                                        var a = r.options.resize.call(r, e, t, n, i),
                                                        ...
                                                        switch (((u.width = a.trgWidth), (u.height = a.trgHeight), o > 4 && ((u.width = a.trgHeight), (u.height = a.trgWidth)), o)) {
                                                            ...
                                                            case 6:
                                                                ...
                                                                break;
                                                            case 7:
                                                                d.rotate(0.5 * Math.PI), d.translate(u.height, -u.width), d.scale(-1, 1);
                                                                break;
                                                            case 8:
                                                                d.rotate(-0.5 * Math.PI), d.translate(-u.height, 0);
                                                        }
                                                        l(d, c, null != a.srcX ? a.srcX : 0, null != a.srcY ? a.srcY : 0, a.srcWidth, a.srcHeight, null != a.trgX ? a.trgX : 0, null != a.trgY ? a.trgY : 0, a.trgWidth, a.trgHeight);
                                                        var h = u.toDataURL("image/png");
                                                        if (null != s) return s(h, u);
                                                    })
                                                );
                                            }),
                                            null != s && (c.onerror = s),
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        for (var t = 0, n = (n = e); ; ) {
                                            if (t >= n.length) break;
                                            var i = n[t++];
                                            (i.processing = !0), (i.status = s.UPLOADING), this.emit("processing", i);
                                        }
                                            ...
                                            if (e[0].upload.chunked) {
                                                ...
                                                var a = function () {
                                                    ...
                                                    if (!(n >= i.upload.totalChunkCount)) {
                                                        ...
                                                        var a = n * t.options.chunkSize,
                                                            r = Math.min(a + t.options.chunkSize, i.size),
                                                            l = {
                                                                name: t._getParamName(0),
                                                                data: o.webkitSlice ? o.webkitSlice(a, r) : o.slice(a, r),
                                                ...
                                                if (
                                                    ((i.upload.finishedChunkUpload = function (n) {
                                                        var o = !0;
                                                        (n.status = s.SUCCESS), (n.dataBlock = null), (n.xhr = null);
                                                        for (var r = 0; r < i.upload.totalChunkCount; r++) {
                                                            if (void 0 === i.upload.chunks[r]) return a();
                                                            i.upload.chunks[r].status !== s.SUCCESS && (o = !1);
                                                        }
                                                        o &&
                                                    ...
                                                    for (var r = 0; r < i.upload.totalChunkCount; r++) a();
                                                else a();
                                            } else {
                                ...
                                },
                                {
                                    key: "_uploadData",
                                    value: function (e, t) {
                                        for (var n = this, i = new XMLHttpRequest(), o = 0, a = (a = e); ; ) {
                                            if (o >= a.length) break;
                                            a[o++].xhr = i;
                                        }
                                        e[0].upload.chunked && (e[0].upload.chunks[t[0].chunkIndex].xhr = i);
                                        var r = this.resolveOption(this.options.method, e),
                                        ...
                                        for (var u in (this.options.headers && s.extend(c, this.options.headers), c)) {
                                            var d = c[u];
                                        ...
                                        if (this.options.params) {
                                            ...
                                            for (var f in ("function" == typeof p && (p = p.call(this, e, i, e[0].upload.chunked ? this._getChunk(e[0], i) : null)), p)) {
                                                var m = p[f];
                                                h.append(f, m);
                                            }
                                        }
                                    ...
                                    value: function (e, t) {
                                        for (
                                            var n = this,
                                                ...
                                                o = 0,
                                                s = function (s) {
                                                    n.options.transformFile.call(n, e[s], function (n) {
                                                        (i[s] = n), ++o === e.length && t(i);
                                                    });
                                                },
                                                a = 0;
                                            a < e.length;
                                    ...
                                    value: function (e) {
                                        if ("FORM" === this.element.tagName)
                                            for (var t = 0, n = (n = this.element.querySelectorAll("input, textarea, select, button")); ; ) {
                                                ...
                                                if ((s && (s = s.toLowerCase()), null != o))
                                                    if ("SELECT" === i.tagName && i.hasAttribute("multiple"))
                                                        for (var a = 0, r = (r = i.options); ; ) {
                                                            if (a >= r.length) break;
                                                            var l = r[a++];
                                                            l.selected && e.append(o, l.value);
                                                        }
                                                    else (!s || ("checkbox" !== s && "radio" !== s) || i.checked) && e.append(o, i.value);
                                            }
                                    },
                                },
                                {
                                    ...
                                    value: function (e, t, n) {
                                        ...
                                        if (void 0 !== n) {
                                            if (((i = (100 * n.loaded) / n.total), e[0].upload.chunked)) {
                                                var o = e[0],
                                                    s = this._getChunk(o, t);
                                                (s.progress = i), (s.total = n.total), (s.bytesSent = n.loaded);
                                                (o.upload.progress = 0), (o.upload.total = 0), (o.upload.bytesSent = 0);
                                                for (var a = 0; a < o.upload.totalChunkCount; a++)
                                                    void 0 !== o.upload.chunks[a] && void 0 !== o.upload.chunks[a].progress && ((o.upload.progress += o.upload.chunks[a].progress), (o.upload.total += o.upload.chunks[a].total), (o.upload.bytesSent += o.upload.chunks[a].bytesSent));
                                            ...
                                            for (var f = 0, m = (m = e); ; ) {
                                                if (f >= m.length) break;
                                                var g = m[f++];
                                                (100 === g.upload.progress && g.upload.bytesSent === g.upload.total) || (p = !1), (g.upload.progress = i), (g.upload.bytesSent = g.upload.total);
                                            }
                                            if (p) return;
                                            for (var v = 0, b = (b = e); ; ) {
                                                if (v >= b.length) break;
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, n) {
                                        for (var i = 0, o = (o = e); ; ) {
                                            if (i >= o.length) break;
                                            var a = o[i++];
                                            (a.status = s.SUCCESS), this.emit("success", a, t, n), this.emit("complete", a);
                                        }
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, n) {
                                        for (var i = 0, o = (o = e); ; ) {
                                            if (i >= o.length) break;
                                            var a = o[i++];
                                            (a.status = s.ERROR), this.emit("error", a, t, n), this.emit("complete", a);
                                        }
            ...
            s.initClass(),
                ...
                (s.optionsForElement = function (e) {
                    return e.getAttribute("id") ? s.options[r(e.getAttribute("id"))] : void 0;
                }),
                (s.instances = []),
                ...
                (s.discover = function () {
                    ...
                    return (function () {
                        for (var t = [], n = 0, i = (i = e); ; ) {
                            if (n >= i.length) break;
                            var o = i[n++];
                            !1 !== s.optionsForElement(o) ? t.push(new s(o)) : t.push(void 0);
                        }
                        return t;
                    })();
                }),
                ...
                (s.isBrowserSupported = function () {
                    ...
                    if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
                        if ("classList" in document.createElement("a"))
                            for (var t = 0, n = (n = s.blacklistedBrowsers); ; ) {
                                if (t >= n.length) break;
                ...
                (s.dataURItoBlob = function (e) {
                    for (var t = atob(e.split(",")[1]), n = e.split(",")[0].split(":")[1].split(";")[0], i = new ArrayBuffer(t.length), o = new Uint8Array(i), s = 0, a = t.length, r = 0 <= a; r ? s <= a : s >= a; r ? s++ : s--) o[s] = t.charCodeAt(s);
                    return new Blob([i], {
                        type: n,
                    });
                });
            ...
            (s.createElement = function (e) {
                ...
                (s.getElements = function (e, t) {
                    ...
                    if (e instanceof Array) {
                        i = [];
                        try {
                            for (var o = 0, s = (s = e); !(o >= s.length); ) (n = s[o++]), i.push(this.getElement(n, t));
                        } catch (e) {
                            i = null;
                        }
                    } else if ("string" == typeof e) {
                        i = [];
                        for (var a = 0, r = (r = document.querySelectorAll(e)); !(a >= r.length); ) (n = r[a++]), i.push(n);
                ...
                (s.confirm = function (e, t, n) {
                    return window.confirm(e) ? t() : null != n ? n() : void 0;
                }),
                (s.isValidFile = function (e, t) {
                    if (!t) return !0;
                    t = t.split(",");
                    for (var n = e.type, i = n.replace(/\/.*$/, ""), o = 0, s = (s = t); ; ) {
                        if (o >= s.length) break;
                        var a = s[o++];
                ...
                (s.ERROR = "error"),
                (s.SUCCESS = "success");
            var l = function (e, t, n, i, o, s, a, r, l, c) {
                    var u = (function (e) {
                        e.naturalWidth;
                        ...
                        i.drawImage(e, 0, 0);
                        for (var o = i.getImageData(1, 0, 1, t).data, s = 0, a = t, r = t; r > s; ) {
                            0 === o[4 * (r - 1) + 3] ? (a = r) : (s = r), (r = (a + s) >> 1);
                        }
                        var l = r / t;
                        return 0 === l ? 1 : l;
                    })(t);
                    return e.drawImage(t, n, i, o, s, a, r, l, c / u);
                },
                c = (function () {
                    function e() {
                        i(this, e);
                    ...
                    return (
                        t(e, null, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    for (
                                        var t = "", n = void 0, i = void 0, o = "", s = void 0, a = void 0, r = void 0, l = "", c = 0;
                                        (s = (n = e[c++]) >> 2),
                                            (a = ((3 & n) << 4) | ((i = e[c++]) >> 4)),
                                            (r = ((15 & i) << 2) | ((o = e[c++]) >> 6)),
                                            (l = 63 & o),
                                            isNaN(i) ? (r = l = 64) : isNaN(o) && (l = 64),
                                            (t = t + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(a) + this.KEY_STR.charAt(r) + this.KEY_STR.charAt(l)),
                                            (n = i = o = ""),
                                            (s = a = r = l = ""),
                                            c < e.length;
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    var n = e.replace("data:image/jpeg;base64,", ""),
                                        ...
                                        a = i.slice(o),
                                        r = s;
                                    return (r = (r = r.concat(t)).concat(a));
                                },
                            },
                            {
                                key: "slice2Segments",
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    for (
                                        ...
                                        (t = (this.KEY_STR.indexOf(e.charAt(r++)) << 2) | ((o = this.KEY_STR.indexOf(e.charAt(r++))) >> 4)),
                                            (n = ((15 & o) << 4) | ((s = this.KEY_STR.indexOf(e.charAt(r++))) >> 2)),
                                            (i = ((3 & s) << 6) | (a = this.KEY_STR.indexOf(e.charAt(r++)))),
                                            l.push(t),
                                            64 !== s && l.push(n),
                                            64 !== a && l.push(i),
                                            (t = n = i = ""),
            ...
            (s._autoDiscoverFunction = function () {
                ...
                (function (e, t) {
                    var n = !1,
                        ...
                        c = function i(s) {
                            if ("readystatechange" !== s.type || "complete" === o.readyState) return ("load" === s.type ? e : o)[r](l + s.type, i, !1), !n && (n = !0) ? t.call(e, s.type || s) : void 0;
                        };
    ...
    71: function (e, t, n) {
                ...
                (n = [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return $('<iframe class="file-manager-iframe" frameborder="0" src="'.concat(e, '"></iframe>'));
                        },
                    },
                    {
                    ...
                    },
                    {
                        key: "setFrameHeight",
                        value: function () {
                            this.frame.css("height", 0.8 * window.innerHeight);
                        },
                    },
                    {
                        key: "setModalTitle",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.frame
                                .contents()
                                .find(".table")
                                .on("click", ".select-media", function (t) {
                                    t.preventDefault(), e.events.select(t.currentTarget.dataset), e.options.multiple ? e.options.message && success(e.options.message) : $(".media-picker-modal").modal("hide");
                                });
                        },
                    },
                    {
        ...
        var a = (function () {
                function e() {
                    ...
                    !(function (e, t) {
                        ...
                        $(".pdf-picker").on("click", function (e) {
                            t.pickPDF(e);
                        }),
                        $(".main-pdf-picker").on("click", function (e) {
                            t.pickMainPDF(e);
                        }),
                        this.sortable(),
                    ...
                    (n = [
                        {
                            ...
                            value: function (e) {
                                ...
                                new o({
                                    ...
                                    t.addImage(n, o, i, e.currentTarget);
                                });
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                var t = this,
                                    ...
                                    i = e.currentTarget.hasAttribute("data-multiple"),
                                    s = "pdf";
                                e.currentTarget.hasAttribute("data-filetype") && (s = e.currentTarget.dataset.filetype),
                                    new o({
                                        type: "",
                                        extension: s,
                                        multiple: i,
                                    }).on("select", function (o) {
                                        t.addPDF(n, o, i, e.currentTarget);
                                    });
                            },
                        },
                            ...
                            value: function (e) {
                                ...
                                e.currentTarget.hasAttribute("data-filetype") && (s = e.currentTarget.dataset.filetype),
                                    new o({
                                        ...
                                        t.addMainPDF(n, o, i, e.currentTarget);
                                    });
                            },
                        },

                        {
                            ...
                            value: function (e, t, n, i) {
                                var o = this.getTemplate(e, t);
                                if (n) {
                                    var s = $(i).next(".multiple-images");
                                    s.find(".image-holder.placeholder").remove(), s.find(".image-list").append(o);
                                } else $(i).siblings(".single-image").html(o), $(".image-file-name").val(t.filename);
                            },
                        },
                        {
                            key: "addPDF",
                            value: function (e, t, n, i) {
                                var o = this.getPDFTemplate(e, t);
                                if (n) {
                                    var s = $(i).next(".multiple-images");
                                    s.find(".image-holder.placeholder").remove(), s.find(".image-list").append(o);
                                    var a = s.attr("data-input-validation");
                                    "" != a && $("." + a).val("1");
                                } else $(i).siblings(".single-image").html(o), $(".pdf-file-name").val(t.filename);
                            },
                        },
...

                        {
                            key: "addMainPDF",
                            value: function (e, t, n, i) {
                                var o = this.getMainPDFTemplate(e, t);
                                if (n) {
                                    var s = $(i).next(".multiple-images");
                                    s.find(".image-holder.placeholder").remove(), s.find(".image-list").append(o);
                                    var a = s.attr("data-input-validation");
                                    "" != a && $("." + a).val("1");
                                } else $(i).siblings(".single-image").html(o), $(".main-pdf-file-name").val(t.filename);
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                return $(
                                    '\n            <div class="image-holder">\n                <i class="fas fa-file"></i>\n                <button type="button" id="remove-preview-pdf"  class="btn remove-pdf"></button>\n                <input type="hidden" name="'
                                        .concat(e, '" value="')
                                        .concat(t.id, '">\n                <textarea class="form-control file-display-name" readonly="1">')
                                        .concat(t.filename, "</textarea>\n            </div>\n        ")
                                );
                            },
                        },
                        {
                            key: "getMainPDFTemplate",
                            value: function (e, t) {
                                return $(
                                    '\n            <div class="image-holder">\n                <i class="fas fa-file"></i>\n                <button type="button" id="remove-main-pdf" class="btn remove-pdf"></button>\n                <input type="hidden" name="'
                                        .concat(e, '" value="')
                                        .concat(t.id, '">\n                <textarea class="form-control file-display-name" readonly="1">')
                                        .concat(t.filename, "</textarea>\n            </div>\n        ")
                                );
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                $(".image-holder-wrapper").on("click", ".remove-image", function (t) {
                                    ...
                                    1 === n.find(".image-holder").length && n.html(e.getImagePlaceholder(t.currentTarget.dataset.inputName)), $(".image-file-name").val(""), $(t.currentTarget).parent().remove();
                                }),

                                // $("#remove-main-pdf").on("click", function (t) {
                                //      t.preventDefault();
                                //      console.log('remved');
                                //     $(".main-pdf-file-name").val("");
                                // }), 

                                $(".image-holder-wrapper").on("click", "#remove-main-pdf", function (t) {
                                        t.preventDefault(), console.log(t.currentTarget.dataset);
                                        var n = $(t.currentTarget).closest(".image-holder-wrapper");
                                        if (1 === n.find(".image-holder").length && (n.html(e.getPDFPlaceholder(t.currentTarget.dataset.inputName)), "" != t.currentTarget.dataset.inputValidation)) {
                                            var i = t.currentTarget.dataset.inputValidation;
                                            $("." + i).val("");
                                        }
                                        $(".main-pdf-file-name").val("");
                                        n.hasClass("notRequired") || $(".main-pdf-file-name").val(""), $(t.currentTarget).parent().remove();
                                    }),


                                    $(".image-holder-wrapper").on("click", "#remove-preview-pdf", function (t) {
                                        t.preventDefault(), console.log(t.currentTarget.dataset);
                                        var n = $(t.currentTarget).closest(".image-holder-wrapper");
                                        if (1 === n.find(".image-holder").length && (n.html(e.getPDFPlaceholder(t.currentTarget.dataset.inputName)), "" != t.currentTarget.dataset.inputValidation)) {
                                            var i = t.currentTarget.dataset.inputValidation;
                                        ...
                                        n.hasClass("notRequired") || $(".pdf-file-name").val(""), $(t.currentTarget).parent().remove();
                                    });
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                return '\n            <div class="image-holder placeholder cursor-auto">\n                <i class="fas fa-camera-retro"></i>\n                <input type="hidden" name="'.concat(e, '">\n            </div>\n        ');
                            },
                        },
                        {
                            key: "getPDFPlaceholder",
                            value: function (e) {
        ...
        var u = (function () {
            function e() {
                !(function (e, t) {
                    ...
                    (l.a.autoDiscover = !1),
                    (this.dropzone = new l.a(".dropzone", {
                ...
                (n = [
                    ...
                    },
                    {
                        ...
                        value: (function (e) {
                            ...
                            success(CI.langs["files::files.success_message"]), 0 === this.getUploadingFiles().length && 0 === this.getQueuedFiles().length && setTimeout(DataTable.reload, 1e3, "#files-table .table");
                        }),
                    },
                    {
                        key: "error",
        ...
        n(30), (window.MediaPicker = o), 0 !== $(".image-picker").length && new a(), 0 !== $(".dropzone").length && new u();
    },
});
