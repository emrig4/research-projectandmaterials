...
$phptabs->add_file_tab('history_list',__('History List','wsr'),'option_history_list.php','file');
$phptabs->add_file_tab('history_options',__('History Options','wsr'),'option_history_options.php','file');
