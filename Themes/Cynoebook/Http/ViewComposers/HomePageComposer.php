...
class HomePageComposer
{
    ...
    public function compose($view)
    {
        ...
        $view->with([
            ...
            'featuredCategories' => $this->getFeaturedCategories(), //top 21 categories
            'recentPosts' => $this->getFeaturedPosts(), //get 4 recent posts
            'featuredPosts' => $this->getFeaturedPosts(), //get 4 featured posts
            'featuredServices' => $this->getFeaturedServices(), //6 services
        ]);
    }
    ...
    public function getRecentPosts(){
        return $posts = \BinshopsBlog\Models\BinshopsBlogPost::limit(4)->get();
    }

    public function getFeaturedPosts(){
        return $posts = \BinshopsBlog\Models\BinshopsBlogPost::where('is_featured', true)->limit(4)->get();
    }
