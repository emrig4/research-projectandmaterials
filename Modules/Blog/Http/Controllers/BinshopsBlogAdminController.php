...
use Modules\Blog\Http\Requests\UpdateBinshopsBlogPostRequest;
...
class BinshopsBlogAdminController extends Controller
{
    ...
    public function store_post(CreateBinshopsBlogPostRequest $request)
    {
        ...
        $new_blog_post->is_featured = $request->is_featured;
        $new_blog_post->meta_keywords = $request->meta_keywords;
        $new_blog_post->save();
