...
class CynoebookTabs extends CiTabs
{
    ...
    public function make()
    {
        ...
        $this->group('seo_settings', 'SEO Meta Settings')
            ->add($this->homepageSeo())
            ->add($this->categoriespageSeo())
            ->add($this->contactpageSeo())
            ->add($this->ebookspageSeo())
            ->add($this->blogpageSeo())
            ->add($this->servicespageSeo());    
    ...
    {
        return tap(new CiTab('whatsapp', 'Whatsapp'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->fields([
                'whatsapp_enabled',
                'whatsapp_text',
            ...
            $tab->view('admin.cynoebook.tabs.whatsapp_settings');
        });
    }
    ...
    {
        return tap(new CiTab('homepageSeo', 'Homepage'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_home_page');
        });
    }

    private function categoriesPageSeo()
    {
        return tap(new CiTab('categoriesPageSeo', 'Categories'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_categories_page');
        });
    }

    private function contactPageSeo()
    {
        return tap(new CiTab('contactPageSeo', 'Contact'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_contact_page');
        });
    }

    private function ebooksPageSeo()
    {
        return tap(new CiTab('ebooksPageSeo', 'Ebooks'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_ebooks_page');
        });
    }

    private function blogPageSeo()
    {
        return tap(new CiTab('blogPageSeo', 'Blog'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_blog_page');
        });
    }

    private function servicesPageSeo()
    {
        return tap(new CiTab('servicesPageSeo', 'Services'), function (CiTab $tab) {
            $tab->weight(25);
            $tab->view('admin.cynoebook.tabs.seo_services_page');
        });
    }
