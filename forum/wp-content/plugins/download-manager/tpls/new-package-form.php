             ...
             jQuery('#wpdm-pf').ajaxSubmit({
                 ...
                 success: function(res) {  jQuery('#sving').fadeOut(); jQuery('#nxt').slideDown();
                     ...
                     if(res.result=='_ap_wpdm') {
                         ...
                         jQuery('#wpdm-pf').prepend('<div class="alert alert-success" data-dismiss="alert"><?= esc_attr__( "Package Created Successfully. Opening Edit Window ..." , "download-manager" ); ?></div>');
                     }
                     else {
                         jQuery('#psp').removeClass('fa-spinner fa-spin').addClass('fa-save');
                         jQuery('#publish').removeAttr('disabled');
                         jQuery('#wpdm-pf').prepend('<div class="alert alert-success" data-dismiss="alert"><?= esc_attr__( "Package Updated Successfully" , "download-manager" ); ?></div>');
                     }
                 }
