<div class='add_comment_area'>
    ...
    <form method='post' action="{{route('binshopsblog.comments.add_new_comment', ['blogPostSlug' =>$post->slug] )}}">
        @csrf
        ...
        <div class="form-group ">
            <button type='submit' class="form-control input-sm btn btn-green "><span style="color: white"> Add Comment</span></button>
        </div>
