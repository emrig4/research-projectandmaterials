...
<div class="row clearfix mb-2">
    <div class="col-md-6 clearfix text-left">
        <a href="{{ route('optimize.images', ['dir' => 'blog_images']) }}" class="btn btn-sm btn-default"> 
            Optimize Blog Images
        </a>

        <a href="{{ route('optimize.images', ['dir' => 'storage/media']) }}" class="btn btn-sm btn-default"> 
